...
public class AddressModifyActivity extends SherlockActivity {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if (msg.what == 0) {
				...
				builder.setMessage("修改地址成功，请继续操作");
	...
	private void init() {
		...
		et_name.setText(Const.addressItem.getName());
		et_phone.setText(Const.addressItem.getTelNumber());
		et_address.setText(Const.addressItem.getAddress());
				...
				if (et_name.getText().toString().equals("") || et_phone.getText().toString().equals("")
					...
					new Thread(new Runnable() {
						public void run() {
							...
							addressItem.setAddressID(Const.addressItem.getAddressID());
							...
							if (httpClientUtils.sendPOSTRequestboolean(IPPort.URL_ADDRESSEDIT, xmlStr)) {
